...
.. note::
   ...
   The session information below describes the **v2.2 Docker image** and is
   preserved here for reproducibility of analyses published with that version.
   For v3, all dependencies are declared in ``DESCRIPTION`` and installed
   automatically via ``pak::pkg_install("Pereira-Lab-UF/asc_seurat", dependencies = TRUE)``.

Session information of the Asc-Seurat's environment (Docker image v2.2 — historical)
=====================================================================================
